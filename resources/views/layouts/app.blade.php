            ...
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <div class="logo_laravel">
                        <img src="https://findvectorlogo.com/wp-content/uploads/2018/11/best-doctors-vector-logo.png" style="width: 200px" alt="doc-logo">
            ...
            <div class="col-4 col-md-6 col-lg-2 col-xl-3 mx-auto ">
                ...
                <div class="d-flex justify-content-center">
                    <ul>
                        ...
                        <li>
                            <h6>Partita IVA e codice fiscale 092445564552</h6>
                        </li>
                    </ul>
                </div>
            </div>
